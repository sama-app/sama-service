...
interface BlockRepository {
    fun findAllBlocks(userId: Long, startDateTime: ZonedDateTime, endDateTime: ZonedDateTime): Collection<Block>
    ...
    fun findAllBlocksCached(userId: Long, startDateTime: ZonedDateTime, endDateTime: ZonedDateTime): Collection<Block> {
        return findAllBlocks(userId, startDateTime, endDateTime)
    }
}